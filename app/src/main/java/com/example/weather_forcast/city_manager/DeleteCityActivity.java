...
public class DeleteCityActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    List<String>deleteCites;    //表示存储了删除的城市信息
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteCites = new ArrayList<>();
        // 设置监听事件
        errorIv.setOnClickListener(this);
        rightIv.setOnClickListener(this);
        // 适配器的设置
        adapter = new DeleteCityAdapter(this, mDatas, deleteCites);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.delete_iv_right:
                for(int i = 0; i < deleteCites.size(); i++){
                    String city = deleteCites.get(i);
                    // 调用删除城市的函数
